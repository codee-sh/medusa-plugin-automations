...
export const AdminAutomationsListParams =
  createFindParams().extend({
    id: z.string().optional(),
  })

export const AdminAutomationsRulesListParams =
  createFindParams().extend({
    id: z.string().optional(),
    trigger_id: z.string().optional(),
  })

export const AdminAutomationsActionsListParams =
  createFindParams().extend({
    id: z.string().optional(),
    trigger_id: z.string().optional(),
  })
  ...
  routes: [
    ...
    },
    {
      ...
      middlewares: [
        ...
        validateAndTransformQuery(
          AdminAutomationsRulesListParams,
          {
            defaults: [
              "id",
              "trigger_id",
    ...
    },
    {
      ...
      middlewares: [
        ...
        validateAndTransformQuery(
          AdminAutomationsActionsListParams,
          {
            defaults: [
              "id",
              "trigger_id",
